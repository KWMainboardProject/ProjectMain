...
class Bottom_classification:
    bottom_class = ['Jogger Pants', 'Long Pants', 'Long Skirt', 'Mini Skirt', 'Short Pants']
    dev = "cuda:0"
...
conf, result = bc.classification(model, pre_img)
