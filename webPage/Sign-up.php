...
<html lang="en">
    <head>
        ...
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="acssets/favion.ico" />
        <!-- Bootstrap icons-->
                        ...
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownBlog">
                                    <li><a class="dropdown-item" href="product-list.php">Outer</a></li>
                                    <li><a class="dropdown-item" href="product-list.php">Top</a></li>
                                    <li><a class="dropdown-item" href="product-list.php">Bottom</a></li>
                                    <li><a class="dropdown-item" href="product-list.php">Overall</a></li>
                                </ul>
                            </li>
