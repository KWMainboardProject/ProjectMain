...
{
    class StyleClassification : IStrategyOperateAble
    {
        ...
        public TaskMessage GetMessage()
        {
            ...
            lock (Holder.instance)
            {
                ...
                taskMessage.type = MessageType.Receive_Container_Style;        //set
        ...
        /// </summary>
        /// <returns></returns>
        public static StyleClassification GetInstance()
        {
        ...
        private static class Holder
        {
            ...
            public static StyleClassification instance = new StyleClassification();
        }
    }
}
