...
namespace RequestTaskProcessing.StrategyOperator.Pattern
{
    public class PatternClassification : IStrategyOperateAble
    {
        ...
        protected PatternClassification()
        {
            //plz set gpu device
            ClearResource();
            ...
            session = new InferenceSession(ShareWorkPath.GetInstance().WEIGHT_PATH + @"\pattern.onnx", option);
        }
            ...
            lock (Holder.instance)
            {
                ...
                switch (taskMessage.type) 
                {
                    case MessageType.Request_FindPattern_Top_ImagePath:
                        taskMessage.type = MessageType.Receive_Container_Pattern_Top;
                        break;
                    ...
                    case MessageType.Request_FindPattern_Outer_ImagePath:
                        taskMessage.type = MessageType.Receive_Container_Pattern_Outer;
                        break;
                }
        ...
        /// </summary>
        /// <returns></returns>
        public static PatternClassification GetInstance()
        {
        ...
        private static class Holder
        {
            ...
            public static PatternClassification instance = new PatternClassification();
        }
    }
}
