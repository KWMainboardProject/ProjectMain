...
namespace RequestTaskProcessing.StrategyOperator.SubCategory
{
    class BottomClassification : IStrategyOperateAble
    {
        ...
        protected BottomClassification()
        {
            ...
            session = new InferenceSession(ShareWorkPath.GetInstance().WEIGHT_PATH + @"\Bottom_classification.onnx", option);
        }
        ...
        public void classification(string imagePath)
        {
            ...
            IEnumerable<Prediction> top10 = softmax.Select((x, i) => new Prediction { Label = LabelMap.Bottoms[i], Confidence = x })
                                       .OrderByDescending(x => x.Confidence)
                                       .Take(1);

            Console.WriteLine("Bottom 1 predictions for ResNet50 v2...");
            Console.WriteLine("--------------------------------------------------------------");
        ...
        public TaskMessage GetMessage()
        {
            ...
            lock (Holder.instance)
            {
                ...
                taskMessage.type = MessageType.Receive_Container_SubCategory_Bottom;        //set
        ...
        /// </summary>
        /// <returns></returns>
        public static BottomClassification GetInstance()
        {
        ...
        private static class Holder
        {
            ...
            public static BottomClassification instance = new BottomClassification();
        }
    }
}
